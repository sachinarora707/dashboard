...
$page = file_get_html('https://www.alexa.com/siteinfo/techviola.com');
...
<div id="alexaContainer">
	<p class="alexaSite"><b>Techviola</b></p>
...
<script type="text/javascript">
	$(document).ready(function(){
		if(<?php if($is_improved){echo '0';} else{echo '1';} ?>){
			$("#alexaContainer span.increaseRank").css("backgroundColor","red");
		}
	});
</script>